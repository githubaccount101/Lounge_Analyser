...
public enum TrackD {
    ...
    DYC("GCN YOSHI CIRCUIT","dYC","GCN YOSHI CIRCUIT","YOSHI CIRCUIT","YC"),
    DEA("EXCITEBIKE ARENA","dEA","EXCITEBIKE ARENA","EXCITEBIKE","BIKE","EA"),
    DDD("DRAGON DRIFTWAY","dDD","DRAGON DRIFTWAY","DRIFTWAY","DRAGON", "DD"),
    DMC("MUTE CITY","dMC","MUTE CITY","MUTE"),
    DBP("GCN BABY PARK","dBP","GCN BABY PARK", "BABY","BP"),
    DCL("GBA CHEESE LAND","dCL","GBA CHEESE LAND","CHEESE LAND", "CHEESE","CL"),
